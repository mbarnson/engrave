...
- [ ] Audio understanding via audio LM (Qwen3-Omni-30B-A3B-Instruct, LFM2.5-Audio, Gemini 3 Flash) producing structured musical descriptions
...
- **Audio LM candidates (Stage 3):** Qwen3-Omni-30B-A3B-Instruct (primary local, MoE 3B active, SOTA audio captioning, Apache 2.0, via vllm-mlx on Apple Silicon), LFM2.5-Audio (lightweight local fallback, Matt has experience), Gemini 3 Flash (best for long-form audio, closed API)
