...
- [ ] **AUDP-03**: System produces structured musical descriptions from audio via audio LM (Qwen3-Omni-30B-A3B-Instruct for local inference, Gemini 3 Flash for cloud/long-form), capturing key, tempo, style, dynamics, articulation intent, and structural form
